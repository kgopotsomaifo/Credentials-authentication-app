...
function UnassignUsersForm({ users }) {
  ...
  const handleUnassignUser = async (e) => {
    e.preventDefault();
    ...
    try {
      ...
      const response = await fetch("/users/unassign", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="submit-form">
      <h2>Unassign Users</h2>
      <form onSubmit={handleUnassignUser}>
...
export default UnassignUsersForm;
